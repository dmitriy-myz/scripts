...
vboxmanage modifyvm "${vmname}" --vrde on --vrdeauthtype=null --vrdeaddress=10.40.0.1 --vrdeport=3391
...
vboxmanage storageattach  "${vmname}" --storagectl 'SATA Controller' --port 0 --medium a7ea3581-bfc3-4a98-9e49-63db3cf1ccf4  --type hdd
